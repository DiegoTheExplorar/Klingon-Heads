...
klingon_train, klingon_test, english_train, english_test = train_test_split(
    klingon_sentences, english_sentences, test_size=0.2, random_state=42)

# Create a DataFrame for training and testing
train_df = pd.DataFrame({'translation': klingon_train, 'target': english_train})
test_df = pd.DataFrame({'translation': klingon_test, 'target': english_test})
...
trainer.train()
model.save_pretrained('/ModelTraining/KTE_t5base_e7')
tokenizer.save_pretrained('/ModelTraining/KTE_t5base_e7')